...
public class Ttt {
    ...
    public static void main(String[] args) {
        ...
        b.displayBoard();
        System.out.println("Tic-Tac-Toe AI using MINMAX algorithm\n\n");
        System.out.println("                                    Attention::");
        System.out.println("                                      You can never win");
        System.out.println("Use this matrix to mark responce ");
        b.displayMat();
        System.out.println("Who plays first? (1) AI (2) User? (X: AI , O: User) \n(Enter 1 or 2): ");
        int choice = b.scan.nextInt();
        if(choice == 1){
            Point p = new Point(rand.nextInt(3), rand.nextInt(3));  //plays at a random box
            b.placeAMove(p, 1);     // 1 is AI and computer plays as X
            b.displayMat();
            b.displayBoard();
        }
        ...
        System.out.println("*********************************************************************************");
        System.out.println("                                       AI developed by Ashish pandey roll n.o 33");
    }
}